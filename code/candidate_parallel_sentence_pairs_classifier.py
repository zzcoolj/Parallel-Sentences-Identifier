...
class CandidateParallelSentencePairsClassifier(object):
    ...
    # TODO for test data, don't need write labels & 'training_features.pkl' name is not appropriate.
    @staticmethod
    def preprocessing_data(source_target_and_potential_targets_path,
        ...
        # TODO Maybe don't use stopwords or stemmer for calculating overlap => compare results
        ...
        # Write training_features (original & scaled) and labels_array
        labels_array_output_path = output_folder_path_prefix + 'labels_array.pkl'
        training_features_scaled_output_path = output_folder_path_prefix + 'training_features.pkl'
        training_features_original_output_path = output_folder_path_prefix + 'training_features_original.pkl'
        ...
        return training_features_scaled, labels_array, training_features_original, training_set
    ...
    def prediction(self,
        ...
        test_features_scaled, test_labels_array, test_features_original, test_training_set = self.preprocessing_data(
